...
def get_vulnerabilities(file_name_sc, vulnerabilities):
    ...
    #print('file_name: ', file_name_sc)
   # print('control vul: ', vulnerabilities)
    if vulnerabilities is not None:
        for vul_item in vulnerabilities:
           # print("vul_item['name']: ",vul_item['name'])
...
def generate_cfg(smart_contract,vulnerabilities):
    file_name_sc = smart_contract.split('/')[-1]
    #print("file name source hereeeeeeeeeeeeeeeeee: ", file_name_sc)
    ...
    try:
        ...
        logger.debug(e)
        return None
#    print('call vul: ', vulnerabilities)
    list_vul_info_sc = get_vulnerabilities(file_name_sc, vulnerabilities)
    print('list_vul_info_sc: ', list_vul_info_sc)
