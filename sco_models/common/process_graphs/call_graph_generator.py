...
def get_vulnerabilities(file_name_sc, vulnerabilities):
    ...
    if vulnerabilities is not None:
        for vul_item in vulnerabilities:
            ...
            #print('file_name_sc: ', file_name_sc)
...
def generate_cg(smart_contract,vulnerabilities):
    ...
    print('vulnerabilities_info_in_sc: ',file_name_sc, 'v: ', vulnerabilities_info_in_sc)
